package athing.com.weather.adapters;
...
import athing.com.weather.models.WeatherViewHolder;
...
//        String ulr = "http://openweathermap.org/img/w/"+weatherItem.getId();
        final String icon = weatherItem.getIcon().toString();
        if (icon.equals("01d") ){
            customViewHolder.itemIcon.setImageResource(R.drawable.clear_icon_day);
        }else if (icon.equals("01n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.clear_icon_night);

        }else if (icon.equals("02d")){
            customViewHolder.itemIcon.setImageResource(R.drawable.clouds_icon_day);

        }else if (icon.equals("02n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.clouds_night_icon);

        }else if (icon.equals("03d") || icon.equals("03n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.scatter_clouds);

        }else if (icon.equals("04d")||icon.equals("04n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.broken_clouds);

        }else if (icon.equals("09d")|| icon.equals("09n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.shower_rain);

        }else if (icon.equals("10d")){
            customViewHolder.itemIcon.setImageResource(R.drawable.rain);

        }else if (icon.equals("10n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.rain_night);

        }else if (icon.equals("11d") || icon.equals("11n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.thunderstorm_icon);

        }else if (icon.equals("13d") || icon.equals("13n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.snow);

        }else if (icon.equals("50d") || icon.equals("50n")){
            customViewHolder.itemIcon.setImageResource(R.drawable.mist);

        }else {
            customViewHolder.itemIcon.setImageResource(R.drawable.clear_icon_day);

        }
//        Picasso.with(context).load("http://openweathermap.org/img/w/"+weatherItem.getIcon()+".png").into(customViewHolder.itemIcon);
