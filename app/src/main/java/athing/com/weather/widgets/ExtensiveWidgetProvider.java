...
//            remoteViews.setImageViewBitmap(R.id.widgetIcon, getWeatherIcon(widgetWeather.getIcon(), context));
            ...
            if (widgetWeather.getIcon().equals("01d") ){
